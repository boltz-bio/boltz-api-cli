...
var smallMoleculeDesignEstimateCost = requestflag.WithInnerFlags(cli.Command{
	...
	Flags: []cli.Flag{
		...
		&requestflag.Flag[string]{
			Name:     "chemical-space",
			Usage:    "Chemical space to constrain generated molecules. Use 'enamine_real' for the Enamine REAL chemical space, 'wuxi_galaxi' for the WuXi GalaXi chemical space, or 'none' to disable chemical-space filtering.",
